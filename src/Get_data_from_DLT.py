...
class Get_data():
    ...
    def Log_analyzer(self,logline):
        ...
        if match:
            ...
            self.excel.update(wake_word='Hey Mini', utterance=self.utterance,recognized_text=extracted_text,is_final_asr=bool_asr)
...
if __name__ == "__main__":
   obj = Get_data(r'c:\Users\Adin N S\Downloads\Logs_trace\Logs_trace\traceLog.txt2025-07-15_18-01-21',"Will it rain in Hamburg")
...
class Main_utils_page(QWidget):
    ...
    def create_card(self):
        ...
        connection_group.setFixedSize(720,60)
        ...
        self.ip_path_edit.setFixedSize(600,30)
        ...
        self.exe_path_edit.setFixedSize(590,30)
        ...
        self.log_path_edit.setFixedSize(590,30)
        ...
        self.fp_path_edit.setFixedSize(590,30)
        ...
        self.tech_stack.setFixedSize(600,30)
    ...
    def create_and_schedule_task(self, ip, excel, dir, dlp, load, stack, time_str):
        ...
        bat_file = os.path.join(FILES_DIR, f"{task_name}.bat")
